      ...
      <AnimatePresence>
        ...
        >
          <NuxtImg
            ...
            placeholder-class=""
            @load.native="loadLargeVersion(item.image)"
          />
        </motion.div>
      </AnimatePresence>
    </div>
        ...
        >
          ...
          >
            <NuxtImg
              ...
              format="webp"
              placeholder="/images/placeholder.webp"
              placeholder-class="rotate-diagonal"
...
<script setup>
  ...
  const loadLargeVersion = (imageUrl) => {
    const largeImageUrl = img(imageUrl, {
      format: 'webp',
      height: 1000,
    });
...
<style lang="scss">
  ...
  .rotate-diagonal {
    -webkit-animation: rotate-diagonal 2s linear infinite both;
    animation: rotate-diagonal 2s linear infinite both;
  }
  /* ----------------------------------------------
 * Generated by Animista on 2025-4-28 22:35:25
 ...
 * ----------------------------------------
 */
  @-webkit-keyframes rotate-diagonal {
    0% {
